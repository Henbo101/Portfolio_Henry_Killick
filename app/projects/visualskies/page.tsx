          ...
          <div className="flex flex-col gap-5">
            {[
              ...
              <div key={i} className="flex gap-4 items-start">
                <span className="text-[11px] font-medium text-[var(--text-muted)] mt-1 flex-shrink-0 w-5">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <p className="text-[15px] text-[var(--text-secondary)] leading-[1.7]">{point}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="py-12 border-b border-[var(--border-dashed)]">
          ...
          <div className="flex flex-col gap-6">
            {[
              ...
              <div key={item.decision} className="border-l-2 border-[var(--border-dashed)] pl-5">
